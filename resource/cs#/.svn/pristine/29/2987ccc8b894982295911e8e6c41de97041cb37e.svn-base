...
<?cs #内容区标题?>
<?cs include:"wupcs/modata/content_title.cs"?>
<?cs #图片内容?>
<?cs include:"wupcs/modata/content_media.cs"?>
<?cs #文字内容?>
<?cs include:"wupcs/modata/content_summary.cs"?>

<?cs #智能排版图片容器大小定义?>
<?cs include:"wupcs/modata/smartlayout_image_size.cs"?>
<?cs ####
	/**
	 *内容区初始化，
	 *比如
