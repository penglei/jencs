...
<?cs if: qz_metadata.meta.appid==4 ?>
	...
	<?cs if:(qz_metadata.feedtype==UC_WUP_FEED_TYPE_NEWCOMMENT || qz_metadata.meta.typeid==11 || qz_metadata.meta.typeid==15||qz_metadata.meta.typeid==5) 
