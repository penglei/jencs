<?cs include:"wupcs/data/vote/const.cs"?>
<?cs include:"wupcs/data/vote/common.cs"?>
<?cs include:"wupcs/data/vote/vote_title.cs"?>
<?cs include:"wupcs/data/vote/vote_contentbox.cs"?>
...
<?cs call:data_comment_replies("http://sns.qzone.qq.com/cgi-bin/vote/vote_cgi_v6_reply", "UTF-8")?>
<?cs call:data_comments("http://sns.qzone.qq.com/cgi-bin/vote/vote_cgi_v6_comment", "UTF-8")?>
...
<?cs else ?><?cs #主动?>
	...
	<?cs call:data_comments_more("","",_more_url)?>
...
<?cs else ?>
		...
		<?cs call:data_comments_inputbox("1|1|0|0|0|0|0", vote_comment_param.ret, qz_metadata.meta.userid, 
			"http://sns.qzone.qq.com/cgi-bin/vote/vote_cgi_v6_comment", "UTF-8")?>
<?cs /if?>
