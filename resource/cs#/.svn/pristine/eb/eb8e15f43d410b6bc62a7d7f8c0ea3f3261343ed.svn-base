		...
		<p class="f_reprint c_tx3">
			...
			<?cs #:动画 附件 投票 视频 网页 图片 ?>
				<?cs if:data.attachurl ?>
					<a href="<?cs call:ugc_url_check(data.attachurl,1) ?>" class="c_tx" target="_blank">
				<?cs else ?>
					<a href="http://user.qzone.qq.com/<?cs var:qfv.meta.hostuin ?>/mood/<?cs var:qfv.meta.hostid ?>.1" class="c_tx" target="_blank">
				<?cs /if ?>
				 查看详情
			</a>
		</p>
