 ...
 * etc. */
void string_init (CSSTRING *str);
NEOERR *string_set (CSSTRING *str, const char *buf);
NEOERR *string_append (CSSTRING *str, const char *buf);
NEOERR *string_appendn (CSSTRING *str, const char *buf, int l);
NEOERR *string_append_char (CSSTRING *str, char c);
NEOERR *string_appendf (CSSTRING *str, const char *fmt, ...) ATTRIBUTE_PRINTF(2,3);
NEOERR *string_appendvf (CSSTRING *str, const char *fmt, va_list ap);
NEOERR *string_readline (CSSTRING *str, FILE *fp);
void string_clear (CSSTRING *str);
...
CBOOL reg_search (const char *re, const char *str);
