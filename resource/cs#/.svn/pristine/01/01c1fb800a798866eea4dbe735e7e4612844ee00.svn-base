<div class="feeds_tp_4">
	<div class="txtbox">
		<p><?cs var:qz_metadata.answer ?><br/></p>
	</div>
	<div class="feeds_tp_operate">
		<qz:reply type="link">回答</qz:reply>
		<a href="http://rc.qzone.qq.com/myhome/<?cs var:qz_metadata.qzone_app_ww ?>/<?cs var:qz_metadata.qzone_app_ww_question ?>/<?cs var:qz_metadata.qid ?>/" target="_blank" class="c_tx">查看详情</a>
	</div>
</div>
