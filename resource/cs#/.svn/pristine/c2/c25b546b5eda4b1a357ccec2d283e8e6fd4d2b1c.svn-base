...
<?cs def:data_share_contentbox()?>
	...
	<?cs else ?>
		...
		<?cs else ?>
			...
			<?cs elif:qz_metadata.orgdata.extendinfo.share_subtype == SHARE_srctype_blog || qz_metadata.orgdata.extendinfo.share_subtype == SHARE_srctype_vedio 
				|| qz_metadata.orgdata.extendinfo.share_subtype == SHARE_srctype_picture || qz_metadata.orgdata.extendinfo.share_subtype == SHARE_srctype_album ?>
