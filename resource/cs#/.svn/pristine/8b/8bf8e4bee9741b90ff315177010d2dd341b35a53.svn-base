...
<?cs set:qz_static_action[13] = '回复了我的分享' ?>
<?cs set:qz_static_action[14] = '评论了我的分享' ?>
<?cs set:qz_static_action[15] = '提到了我' ?>
<?cs set:qz_static_action[16] = '分享了我的日志' ?>
<?cs set:qz_static_action[17] = '分享了我的相册' ?>
<?cs set:qz_static_action[18] = '分享了我的照片' ?>
<?cs set:qz_static_action[19] = '分享了我的分享' ?>
<?cs set:qz_static_action[20] = '评论我：' ?>
<?cs set:qz_static_action[21] = '转发我的说说：' ?>
<?cs set:qz_static_action[23] = '中提到我' ?>
<?cs set:qz_static_action[24] = '回复我' ?>
<?cs set:qz_static_action[25] = '转发了提到我的说说：' ?>
...
<?cs set:qz_static_action[32] = '回复我' ?>
...
<?cs set:qz_static_action[54] = '分享了我的微博' ?>
...
<?cs set:qz_static_action[60] = '中回复了我' ?>
<?cs set:qz_static_action[62] = '在分享中回复了我' ?>
...
<?cs set:qz_static_action[68] = '在说说中提到我：' ?>
<?cs set:qz_static_action[69] = '在说说的评论中提到我：' ?>
<?cs set:qz_static_action[70] = '在说说的回复中提到我：' ?>
<?cs set:qz_static_action[71] = '评论了提到我的说说：' ?>
<?cs set:qz_static_action[72] = ' 有了来自' ?>
<?cs set:qz_static_action[73] = '转发我的时光轴：' ?>
<?cs set:qz_static_action[74] = '评论时光轴：' ?>
<?cs set:qz_static_action[75] = '在时光轴中回复：' ?>
<?cs set:qz_static_action[76] = '在时光轴中提到我：' ?>
<?cs set:qz_static_action[77] = '在时光轴的评论中提到我：' ?>
<?cs set:qz_static_action[78] = '在时光轴的回复中提到我：' ?>
<?cs set:qz_static_action[79] = '评论分享：' ?>
<?cs set:qz_static_action[80] = '回复分享：' ?>
<?cs set:qz_static_action[81] = '在分享回复中提到我：' ?>
<?cs set:qz_static_action[82] = '在分享评论中提到我：' ?>
<?cs set:qz_static_action[83] = '在分享中提到我：' ?>
...
<?cs set:qz_static_action[92] = '在歌单中提到了我' ?>
<?cs set:qz_static_action[93] = '评论专辑' ?>
<?cs set:qz_static_action[94] = '回复专辑' ?>
<?cs set:qz_static_action[95] = '在专辑中提到了我' ?>
<?cs set:qz_static_action[96] = '分享给我：' ?>
...
<?cs def:userLink(user, prefix) ?>
	<?cs if:user.who == 1 || user.type == 1?>
		<a href="http://user.qzone.qq.com/<?cs var:user.uin+'?active_channel=1&active_type=4&active_mode='+stat_flag_nick ?>" style="color: #577DA8;text-decoration:none;" class="q_namecard c_tx" link="nameCard_<?cs var:user.uin ?>" target="_blank">
		<?cs if:string.length(prefix) > 0 ?>
			<?cs var:prefix ?>
		<?cs /if ?>
		<span><?cs call:writeUserName(user.uin,user.name) ?></span></a>
	<?cs elif:user.who == 2 || user.type == 2 ?>
		<a href="http://profile.pengyou.qq.com/index.php?mod=profile&u=<?cs var:user.uin ?>" style="color: #577DA8;text-decoration:none;" class="c_tx" target="_blank">
		<?cs if:string.length(prefix) > 0 ?>
			<?cs var:prefix ?>
		<?cs /if ?>
		<?cs var:html_encode(user.name, 1) ?></a>
	<?cs elif:user.who == 3 || user.type == 3 ?>
		<a href="http://rc.qzone.qq.com/myhome/weibo/profile/<?cs var:user.uin ?>" style="color: #577DA8;text-decoration:none;" class="c_tx" target="_blank">
		<?cs if:string.length(prefix) > 0 ?>
			<?cs var:prefix ?>
		<?cs /if ?>
		<?cs var:html_encode(user.name, 1) ?></a>
...
<?cs def:cmtUserLink(user, prefix) ?>
	<?cs if:user.type == 1 ||user.who == 1?>
		<a href="http://user.qzone.qq.com/<?cs var:user.uin ?>" style="color: #577DA8;text-decoration:none;" class="q_namecard nickname c_tx" link="nameCard_<?cs var:user.uin ?>" target="_blank">
		<?cs if:string.length(prefix) > 0 ?>
			<?cs var:prefix ?>
		<?cs /if ?>
...
<?cs def:richContent(cons) ?>
	...
	<?cs def:richContent-items(item) ?>
		...
		<?cs elif:item.type == 'url' ?>
			<a class="c_tx" href="<?cs var:qz_metadata.qz_data.key1+'?active_channel=1&active_type=4&active_mode='+stat_flag ?>" target="_blank"><?cs if:item.text ?><?cs var:item.text ?><?cs else ?><?cs var:item.url ?><?cs /if ?></a>
		<?cs elif:item.type == 'qz_app' ?><?cs #过时，等后台一起把它干掉 ?>
			...
			<?cs if:string.length(item.text2) > 0 ?><p><?cs var:item.text2?></p><?cs /if?>
		...
		<?cs def:randerLike(mod) ?>
			<?cs if:qz_metadata.qz_data.version==1 && !qz_metadata.accessright&&mod.like=='on' ?>
				...
				<?cs if:qz_metadata.qz_data[qz_data_key].LIKE.isliked==1 && string.length(qz_metadata.qz_data.key1)>0 ?>
					<a class="qz_like_btn_v3 c_tx ui_mr10 _likeBtn" islike="<?cs var:qz_metadata.qz_data[qz_data_key].LIKE.isliked||'0' ?>" likecnt="<?cs if:qz_metadata.qz_data[qz_data_key].LIKE.cnt ?><?cs var:qz_metadata.qz_data[qz_data_key].LIKE.cnt ?><?cs else ?>0<?cs /if ?>" unikey="<?cs var:unikey ?>" curkey="<?cs var:qz_metadata.qz_data.key1 ?>" href="javascript:;" >取消赞<?cs call:setCount(qz_metadata.qz_data.key2.LIKE.cnt,qz_metadata.qz_data.key1.LIKE.cnt) ?></a>
				<?cs elif:string.length(qz_metadata.qz_data.key1)>0 ?>
					<a class="qz_like_btn_v3 c_tx ui_mr10 _likeBtn" islike="<?cs var:qz_metadata.qz_data[qz_data_key].LIKE.isliked||'0' ?>" likecnt="<?cs if:qz_metadata.qz_data[qz_data_key].LIKE.cnt ?><?cs var:qz_metadata.qz_data[qz_data_key].LIKE.cnt ?><?cs else ?>0<?cs /if ?>" unikey="<?cs var:unikey ?>" curkey="<?cs var:qz_metadata.qz_data.key1 ?>" href="javascript:;">赞<?cs call:setCount(qz_metadata.qz_data.key2.LIKE.cnt,qz_metadata.qz_data.key1.LIKE.cnt) ?></a>
				<?cs /if ?>
			<?cs /if ?>
		<?cs /def ?>
		...
		<?cs def:btn-items(item) ?>
			...
			<?cs elif:item.type == 2 ?><?cs #:转发 ?>
				<a
					...
					<?cs if:item.param ?>
					data-param="<?cs var:item.param ?>" 
					<?cs else ?>
					data-param="<?cs call:buildForwardParam(0,"","") ?>" 
					<?cs /if ?>
			...
			<?cs elif:item.type == 3 ?><?cs #:分享 ?>
				<a 
					...
					<span class="c_tx ui_mr10" href="javascript:;">分享<?cs call:setCount(qz_metadata.qz_data.key1.ZF.cnt,0) ?></span>
				</a>
			...
			<?cs elif:item.type == "visitor" ?>
				...
				<?cs /if ?>
				<?cs #:相册扛不住了，不给浏览数了 ?>
				<?cs if:0&&qz_metadata.metadata.appid == 4 ?>
					<?cs if:qz_metadata.qz_data.version!=1 ?>
...
<?cs #:Feed整块内容区的标题 ?>
<?cs def:subTitle() ?>
<?cs if:subcount(qz_metadata.content_box.subtitle) > 0?>
...
<?cs if:qz_metadata.content_box.media.media.game == 1 ?>
	<div class="controls_<?cs var:qz_metadata.content_box.media.media.itemid ?>" >
		<a 
			data-cmd="qz_popup" 
			href="javascript:void(0);" 
			...
			data-param="<?cs var:qz_metadata.content_box.media.media.qz_popup.param ?>" >
				<img src="/ac/b.gif" title="点击试玩" onload="QZFL.media.adjustImageSize(120,120,restXHTML('<?cs call:htmlEncodeVar(qz_metadata.content_box.media.media.src,2,0) ?>'));" />
		</a>
	</div>
	<div class="player_<?cs var:qz_metadata.content_box.media.media.itemid ?>" style="display:none;">
		...
		<div style="width:400px">
	        <p style="float:left"><?cs var:qz_metadata.content_box.content.con.text ?></p>
			<a 
				data-cmd="qz_popup" 
				style="float:right" 
				href="javascript:void(0);" 
...
<?cs def:extendInfo(mod) ?>
	...
	<?cs #动态合并附加信息?>
	<?cs if:mod.mod.name == "extendInfo" && mod.mod.dynamic == "on"?>
		<p class="f_reprint c_tx3 __samefeed_users_wrapper none">
			<span class="ur_mr10">
				<span class="__samefeed_users"></span>
				<?cs alt:qz_metadata.extend_info.ext_text ?><?cs /alt?><?cs var:mod.mod.text?>
			</span>
		</p>
	<?cs /if ?>	
<?cs /def ?>
...
<?cs def:show_GPuls(medias) ?>
	...
	<?cs else ?>
		...
		<div class="img_box_preview">
			...
			<?cs /if?>
			<?cs if:mydef_picCount>1 && qz_metadata.content_box.media.multiupnumber>1 ?>
				...
				<?cs else ?>
					...
					>
				<?cs /if ?>
						共<?cs var:medias.multiupnumber ?>张
				</a>
			<?cs /if ?>
		</div>
	<?cs /if ?>
...
<?cs def:contentBoxCommon-img(mod, isShowOnePic) ?>
	<?cs if:qz_metadata.content_box.media || qz_metadata.content_box.media.media.src || qz_metadata.content_box.media.media.type || qz_metadata.content_box.media.media.0.src || qz_metadata.content_box.media.media.0.avatar ?>
		<?cs if:qz_metadata.content_box.media.newtype ?>
			<?cs call:photoViewWithSmartImage(qz_metadata.content_box.media,mod) ?>
		<?cs else ?>
			<div class="img_box" richinfo="<?cs var:qz_metadata.content_box.media.media.qz_popup.param ?>" url1="<?cs call:htmlEncodeVar(qz_metadata.content_box.media.media.src,2,0) ?>" url2="<?cs call:htmlEncodeVar(qz_metadata.content_box.media.media.src_big,2,0) ?>" url3="<?cs call:htmlEncodeVar(qz_metadata.content_box.media.media.src_org,2,0) ?>">
				<?cs #:多张图而且弹出框的情况 ?>
...
<?cs #isVideo:是否视频类 isMargin:是否加边距 ?>
	...
	<?cs if:qz_metadata.content_box.detailurl || subcount(qz_metadata.content_box[qz_content_name]) > 0 || subcount(qz_metadata.content_box.title) > 0?>		
		<?cs if:qz_metadata.content_box[qz_content_name].con.type =='qz_app' ?>
			<?cs #:appstore feeds content区域的class不是默认的txt_box ?>
		...
		<div class="<?cs var:qz_cont_box_class ?> <?cs if:qz_metadata.content_box.media.media.game == 1 ?>controls_<?cs var:qz_metadata.content_box.media.media.itemid ?><?cs /if ?>">
		...
		<?cs with:bgid =qz_metadata.content_box.bgid ?>
			<div style="background:url('http://ctc.qzs.qq.com/qzone/space_item/orig/<?cs var:bgid % 16?>/<?cs var:bgid?>/feed.png')" class="txt_blog_template">
...
<?cs def:contentBoxCommon(type, mod) ?>
	...
	<?cs /if ?>
	<?cs if:subcount(qz_metadata.magicemotion) > 0 || subcount(qz_metadata.content_box.media) > 0  || subcount(qz_metadata.vote_box) > 0 || subcount(qz_metadata.lbs) > 0 || subcount(qz_metadata.attach) > 0 || subcount(qz_metadata.profile) > 0 || subcount(qz_metadata.content_box[qz_content_name]) > 0 || subcount(qz_metadata.timeline) > 0 || subcount(qz_metadata.music_box) > 0 || subcount(qz_metadata.clock_box) > 0 ?>
	<div class="<?cs var:className ?>">
		<?cs call:subTitle()?>
		<?cs if:subcount(qz_metadata.magicemotion) > 0 || qz_metadata.content_box.detailurl || subcount(qz_metadata.content_box[qz_content_name]) > 0 || qz_metadata.content_box.media || qz_metadata.content_box.media.media.src || qz_metadata.content_box.media.media.0.src || qz_metadata.content_box.media.media.0.avatar ?>
			<?cs set:qz_is_txtimg_class = '' ?>
			<?cs if:(subcount(qz_metadata.content_box[qz_content_name]) > 0 ||subcount(qz_metadata.content_box.title) > 0) && (qz_metadata.content_box.media || qz_metadata.content_box.media.media.src || qz_metadata.content_box.media.media.0.src) ?>
...
<?cs def:contentBox(mod)?>
	...
	<?cs if:qz_metadata.content_box[qz_content_name].con.type == 'qz_app' ||  (qz_metadata.content_box.media.media.avatar && qz_metadata.metadata.appid == 217) ?>
...
<?cs def:randerLikeInfo(mod) ?>
	<?cs if: qz_metadata.qz_data.version==1 ?>
		...
		<?cs else ?>
			<?cs set:likeinfo=0 ?>
		<?cs /if ?>
		<?cs if:mod.like=='on' && (qz_metadata.qz_data[qz_data_key].LIKE.isliked || likeinfo>0) ?>
			<div class="f_like _likeInfo" likeinfo="<?cs var:likeinfo ?>">
				...
				<?cs if:qz_metadata.qz_data[qz_data_key].LIKE.isliked ?>
					<?cs if:qz_metadata.qz_data[qz_data_key].LIKE.cnt>1 ?>
						<span class="_ilike">我<?cs if:likeinfo>0||qz_metadata.qz_data[qz_data_key].LIKE.cnt-0>2 ?>和<?cs /if ?></span><?cs call:setFriend() ?><?cs if:likeinfo>1 ?>等<?cs /if ?><span class="_likecnt"><?cs if:qz_metadata.qz_data[qz_data_key].LIKE.cnt-0>2 ?><?cs var:qz_metadata.qz_data[qz_data_key].LIKE.cnt-1 ?>人都<?cs /if ?></span>觉得很赞
					<?cs elif:qz_metadata.qz_data[qz_data_key].LIKE.cnt==1 ?>
						<span class="_ilike">我觉得很赞</span>
					<?cs /if ?>
				<?cs else ?>
					<?cs call:setFriend() ?><?cs if:likeinfo>0&&qz_metadata.qz_data[qz_data_key].LIKE.cnt>2 ?>等<?cs /if ?><span class="_likecnt"><?cs if:qz_metadata.qz_data[qz_data_key].LIKE.cnt-0>2||likeinfo>2 ?><?cs var:qz_metadata.qz_data[qz_data_key].LIKE.cnt ?>人
					<?cs /if ?><?cs if:likeinfo>1&&qz_metadata.qz_data[qz_data_key].LIKE.cnt>1 ?>都<?cs /if ?></span>觉得很赞
				<?cs /if ?>
			</div>
		<?cs /if ?>
	<?cs /if ?>
	...
	<?cs if:subcount(qz_metadata.comments) > 0 ?>
		<?cs set:cmtdata = qz_metadata.comments ?>
				<?cs def:comment-items(item) ?>
					<li class="comments_item bor3">
						<div class="comments_item_bd">
							...
							<div class="comments_content"><?cs #:昵称 ?><?cs call:cmtUserLink(item.user, '') ?><?cs #:评论内容 ?> : <?cs call:comment_icon(item)?><?cs call:richContent(item.content) ?>
								<div class="comments_op"><span class="c_tx3 ui_mr10"><?cs #:日期 ?><?cs var:item.time.text ?></span>
								<?cs if:qz_metadata.metadata.fwd_config>0 ?>
									<span class="ui_mr10">
										<a
											...
											data-version="4" 
											data-type="RetweetBox" 
											data-param="<?cs call:buildForwardParam(1,item,"") ?>" 
								...
								<?cs /if ?>
								<?cs if:subcount(item.qz_reply) > 0 ?><span class="ui_mr10"><qz:reply version="6.<?cs alt:item.qz_reply.btnstyle?>2<?cs /alt ?>" action="<?cs var:item.qz_reply.action ?>" param="<?cs var:item.qz_reply.param ?>" charset="<?cs var:item.qz_reply.charset ?>" maxLength="<?cs var:item.qz_reply.maxlength ?>" tuin="<?cs var:item.qz_reply.tuin ?>" config="<?cs var:item.qz_reply.config ?>">回复</qz:reply></span><?cs /if ?>
								<?cs if:subcount(item.qz_audit) > 0 ?><a class="c_tx ui_mr10" href="javascript:;" onclick="QZONE.ICFeeds.Interface.auditPassExtend({dataonly:1,src:'<?cs var:item.qz_audit.src ?>',param:'<?cs var:item.qz_audit.param ?>'})">通过审核</a><?cs /if ?>
								<?cs if:qz_isOwner && item.qz_delete.action ?>
									<span class="ui_mr10"><qz:delete action="<?cs var:item.qz_delete.action ?>" param="<?cs var:item.qz_delete.param ?>">删除</qz:delete></span>
								<?cs /if ?>
								</div>
							</div>
							<?cs def:reply-items(comment,item) ?>
									<li class="comments_item bor3">
										<div class="comments_item_bd">
											<div class="ui_avatar"><?cs #:头像 ?><?cs call:userIcon(item.user) ?></div>
											<div class="comments_content"><?cs #:昵称 ?><?cs call:cmtUserLink(item.user, '') ?><?cs #:评论内容 ?> : <?cs call:richContent(item.content) ?>
												<div class="comments_op"><span class="c_tx3 ui_mr10"><?cs #:日期 ?><?cs var:item.time.text ?></span>
												...
												<?cs if:qz_metadata.metadata.fwd_config>1 ?>
													<span class="ui_mr10">
														<a 
															...
															data-version="4" 
															data-type="RetweetBox" 
															data-param="<?cs call:buildForwardParam(2,comment,item) ?>" 
															data-needcontainer="2" 
															data-scene="reply" 
															data-src="/qzone/app/mood/retweetBoxFacade.js" 
															class="c_tx ui_mr10" 
											...
											<?cs /if ?>
												<?cs if:subcount(item.qz_reply) > 0 ?><span class="ui_mr10"><qz:reply version="6.4" action="<?cs var:item.qz_reply.action ?>" param="<?cs var:item.qz_reply.param ?>" charset="<?cs var:item.qz_reply.charset ?>" maxLength="<?cs var:item.qz_reply.maxlength ?>" tuin="<?cs var:item.qz_reply.tuin ?>" config="<?cs var:item.qz_reply.config ?>" >回复</qz:reply></span><?cs /if ?>
												<?cs if:subcount(item.qz_audit) > 0 ?><a class="c_tx ui_mr10" href="javascript:;" onclick="QZONE.ICFeeds.Interface.auditPassExtend({dataonly:1,src:'<?cs var:item.qz_auidit.src ?>',param:'<?cs var:item.qz_audit.param ?>'})">通过审核</a><?cs /if ?>
												<?cs if:qz_isOwner && item.qz_delete.action ?>
													<span class="ui_mr10"><qz:delete action="<?cs var:item.qz_delete.action ?>" param="<?cs var:item.qz_delete.param ?>">删除</qz:delete></span>
												<?cs /if ?>
												</div>
				...
				<div class="mod_comments"> 
					...
					<div class="comments_list <?cs if:qz_metadata.noreply ?>none<?cs /if ?>">
						<?cs if:qz_metadata.totalcomment > 3 && qz_metadata.comments.qz_more.action ?>
							<div class="comments_list_more"><qz:more 
								action="<?cs var:qz_metadata.comments.qz_more.action ?>" 
								param="<?cs var:qz_metadata.comments.qz_more.param ?>" 
								charset="<?cs var:qz_metadata.comments.qz_more.charset ?>" 
							>展开剩余<?cs var:qz_metadata.comments.qz_more.count ?>条评论</qz:more></div>
						<?cs /if ?>
						<?cs if:qz_metadata.metadata.appid==311  || qz_metadata.metadata.appid==4 ?>
							...
							<?cs /if ?>
						<?cs else ?>
							<?cs if:!qz_metadata.noreply && qz_metadata.comments.qz_more.url ?>
...
<?cs def:actionTitle() ?>
	...
	<?cs def:actionTitle_content() ?>
		<?cs call:richContent(qz_metadata[qz_actiontitle_name].content) ?>
	<?cs /def ?>

	<?cs call:actionTitle_action() ?>
	<?cs if: string.find(actionWord, "转发")>=0 ?>
		<?cs call:actionTitle_content() ?>
		<?cs set: is_retweet=1 ?>
	<?cs /if ?>
<?cs /def ?>
...
<?cs def:start(module) ?>	
	...
	<?cs if:qz_metadata.isactfeed==1 ?>
		...
		<?cs if:qz_metadata.metadata.appid==311 ?>
			<?cs call:richContent(qz_metadata.actiontitle.content) ?>
		<?cs elif:subcount(qz_metadata.content_box.content)>0 ?>
			<?cs call:richContent(qz_metadata.content_box.content) ?>
		<?cs elif:subcount(qz_metadata.content_box) ?>
			<?cs call:contentBox(qz_metadata.content_box) ?>
		<?cs /if ?>
		<?cs if:qz_metadata.content_box.media.media.type=="pic" || qz_metadata.content_box.media.media.0.type=="pic" ?>
			<?cs if:subcount(qz_metadata.content_box.media.media.0)>0 ?>
				<?cs set: pic_url = qz_metadata.content_box.media.media.0.src ?>
			<?cs else ?>
				<?cs set: pic_url = qz_metadata.content_box.media.media.src ?>
			<?cs /if ?>
			<div style="height:158px;width:192px;overflow:hidden;margin-top:5px;text-align: center;">
				<a target="_blank" href="<?cs var:qz_metadata.qz_data.key1+'?active_channel=1&active_type=4&active_mode='+stat_flag ?>" style="color:#333333;text-decoration: none">
					<img style="width:192px;" src="<?cs var:pic_url ?>" alt="" style="border:0 none;">
				</a>
			</div>
		<?cs /if ?>
	<?cs else ?>
		<?cs #被动feed ?>
		<?cs #找相应用户的最后一个回复，没有的话再看下是否是评论 ?>
		<?cs set:last = -1 ?>
		<?cs set:replys = qz_metadata.comments.comment.replies.reply ?>
		<?cs set:opuin = qz_metadata.metadata.opuin ?>
		<?cs #转发 ?>
		<?cs call:actionTitle() ?>
		<?cs if: is_retweet ==1 ?>
		<?cs elif:subcount(qz_metadata.comments.comment.replies.reply.0)>0 ?>
			<?cs loop:i=0, subcount(qz_metadata.comments.comment.replies.reply), 1 ?>
				<?cs if:qz_metadata.comments.comment.replies.reply[i].user.uin==opuin ?>
					<?cs set:last = i ?>
				<?cs /if ?>	
			<?cs /loop ?>
			<?cs if:last != -1 ?>
				<?cs call:richContent(qz_metadata.comments.comment.replies.reply[last].content) ?>
			<?cs /if ?>	
		<?cs elif:qz_metadata.comments.comment.replies.reply.user.uin && qz_metadata.comments.comment.replies.reply.user.uin==opuin ?>
			<?cs call:richContent(qz_metadata.comments.comment.replies.reply.content) ?>
			<?cs set:last = 999 ?>
		<?cs /if ?>

		<?cs if: is_retweet ==1 ?>
		<?cs elif:last != -1 ?>
		<?cs elif:subcount(qz_metadata.comments.comment.content)>0 ?>
			<?cs #这是评论 ?>
			<?cs call:richContent(qz_metadata.comments.comment.content) ?>
		<?cs elif:subcount(qz_metadata.content_box.content)>0 ?>
			<?cs #说说提到等 ?>
			<?cs call:richContent(qz_metadata.content_box.content) ?>
		<?cs elif:subcount(qz_metadata.content_box.content_2)>0 ?>
			<?cs #说说提到等 ?>
			<?cs call:richContent(qz_metadata.content_box.content_2) ?>
		<?cs /if ?>
	<?cs /if ?>
<?cs /def ?>
