...
<?cs def:data_vote_contentbox()?>
	<?cs call:data_vote_base(qz_metadata.votedata.vote_type, qz_metadata.votedata.vote_topicid, qz_metadata.votedata.vote_owner, 
		qz_metadata.votedata.vote_id, qz_metadata.votedata.vote_limit, qz_metadata.votedata.vote_num) ?>
	<?cs if:qz_metadata.orgdata.itemdata[0].picinfo[1].url ?>
		<?cs call:data_vote_pic(qz_metadata.orgdata.itemdata[0].picinfo[1].url, qz_metadata.orgdata.itemdata[0].action) ?>
	<?cs elif:qz_metadata.orgdata.itemdata[0].picinfo[0].url ?>
