...
<div  class="feeds_tp_6">
		...
		<div class="feeds_comment">
			...
			<?cs if:qz_metadata.qz_reply.action || qz_metadata.qz_reply.0.action?>
				<qz:reply action="<?cs var:qz_metadata.qz_reply.action ?>" param="<?cs var:qz_metadata.qz_reply.param ?>" type="text" charset="UTF8" maxLength="140" version="6" btnstyle="6.1">
					回复
				</qz:reply>
			<?cs /if ?>
		</div>
