...
<?cs set:qz_source_type[24] = 'QQ空间iPhone版'?>
<?cs set:qz_source_type[24].url = 'http://z.qzone.com?from=iphonegrzxpl'?>
<?cs set:qz_source_type[25] = 'QQ空间Android版'?>
<?cs set:qz_source_type[25].url = 'http://z.qzone.com?from=andriodgrzxpl'?>
...
<?cs if:qz_metadata.source.name != "QQ空间" && qz_metadata.source.name != "Qzone" && qz_metadata.source.type != 1?>
	<span class="ui_mr10">
