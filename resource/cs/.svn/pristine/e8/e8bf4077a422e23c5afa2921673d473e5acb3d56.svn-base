...
<?cs def:data_comment_deletebtn(action, param)?>
	<?cs with:commentItem = qz_metadata[_g_comment_meta_path]?>
		<?cs if:qz_metadata.orgdata.uin == qz_metadata.meta.loginuin || qz_metadata.meta.loginuin == commentItem.uin?>
...
<?cs def:data_commentReply_deletebtn(action, param)?>
		<?cs with:replyItem = qz_metadata[_g_commentReply_meta_path]?>
		<?cs #删除逻辑详见评论删除按钮?>
		<?cs if:qz_metadata.orgdata.uin == qz_metadata.meta.loginuin || replyItem.uin == qz_metadata.meta.loginuin ?>
