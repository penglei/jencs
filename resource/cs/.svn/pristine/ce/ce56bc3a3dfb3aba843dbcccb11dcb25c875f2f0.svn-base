...
<?cs def:data_source()?>
	...
	<?cs if:qz_source_type[_platformid][_subplatformid] ?>
		<?cs if:_useragent?>
			<?cs call:_data_source(_useragent, qz_source_type[_platformid][_subplatformid].url)?>
		<?cs else?>
			<?cs call:_data_source(qz_source_type[_platformid][_subplatformid], qz_source_type[_platformid][_subplatformid].url)?>
		<?cs /if?>
	<?cs /if?>
<?cs /def?>
