<?cs include:"wupcs-v8/data/follow/const.cs"?>
<?cs include:"wupcs-v8/data/follow/common.cs"?>
<?cs include:"wupcs-v8/data/follow/follow_contentbox.cs"?>
<?cs include:"wupcs-v8/data/follow/follow_title.cs"?>
<?cs include:"wupcs-v8/data/follow/follow_like_extendinfo.cs"?>
	...
	<?cs elif:qz_metadata.orgdata.extendinfo.appid == FOLLOW_srctype_photo ?>
		...
		<?cs else ?>
			<?cs set:photo_config = "{config:'1|1|0|0|0|0|0', atuin:" 
				+ qz_metadata.opinfo.opuin + ",atnick:'" + _nickname + "'}" ?>
		<?cs /if?>
		<?cs call:data_comments_inputbox(photo_config, photo_param, qz_metadata.meta.userid, "http://photo.qq.com/cgi-bin/common/cgi_add_piccomment", "utf-8")?>
