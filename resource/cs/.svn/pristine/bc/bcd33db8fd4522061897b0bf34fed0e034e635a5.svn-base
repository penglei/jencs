...
<?cs if:qz_metadata.scope == SCOPE_FRIENDSHIP_ME_TO_FRIEND ?>
	...
	<?cs elif:qz_metadata.orgdata.itemdata.0.extendinfo.nSpecialType==NSPECIALTYPE_FOR_YUYIN?><?cs #/*语音礼物 有些语音礼物是没有语音的... 如果这样就不显示“语音”两字了*/?>
		<?cs call:data_title_tipTxt("送")?>
		<?cs call:data_title_nick(qz_metadata.friendshipuin, USER_PLATFORM_WHO_QZONE, qz_metadata.friendshipnick)?>
...
<?cs if:qz_metadata.orgdata.extendinfo.gifttype != APP_GIFT?><?cs #/*title里有具体的礼物*/#?>
	<?cs call:data_title_txtPopup(
				...
				1, 625, 495 )?>
<?cs else ?>
	<?cs call:data_title_url(qz_metadata.orgdata.itemdata.0.name, qz_metadata.orgdata.srcurl)?>
<?cs /if?>
...
<?cs call:i()?>
<?cs call:data_cntmedia_pic(0, picDataSrc, "")?>
<?cs call:data_cntmedia_limitImgSize(data_cntmedia_pic.ret, 100, 150)?>
