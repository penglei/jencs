...
<?cs if:qz_metadata.feedtype == UC_WUP_FEED_TYPE_COMMPSV ||
	...
	<?cs if:qz_metadata.orgdata.subtype == COUPLE_srctype_mood ?>
		...
		<?cs call:data_commentReply_more("http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_share_qzone_comment_get", "")?>

		<?cs set:more_param = "uin=" + qz_metadata.orgdata.uin + "^id=" + qz_metadata.orgdata.mkey + "^plat=1^pairkey=" 
			+ qz_metadata.orgdata.extendinfo.pairkey +"^sceneid=" + UC_WUP_FEED_TYPE_SHOW_ACT_COMMALL
	...
	<?cs else ?>
		...
		<?cs call:data_commentReply_more("http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_photo_qzone_comment_get", "")?>
		...
		<?cs set:more_param = "uin=" + qz_metadata.orgdata.uin + "^key=" + qz_metadata.orgdata.itemdata[0].itemid 
			...
			+ "^sceneid=" + UC_WUP_FEED_TYPE_SHOW_ACT_COMMALL + "^picstring=" + qz_metadata.orgdata.extendinfo.picstring
...
<?cs else ?><?cs #主动?>
	...
	<?cs if:qz_metadata.orgdata.subtype == COUPLE_srctype_mood ?>
		<?cs call:data_comments("http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_share_qzone_reply_add", "utf-8")?>
		<?cs call:data_comments_more("http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_share_qzone_comment_get", "http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_share_qzone_comment_get", "")?>
	...
	<?cs else ?>
		<?cs call:data_comments("http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_photo_qzone_reply_add", "utf-8")?>
		<?cs call:data_comments_more("http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_photo_qzone_comment_get", "http://sweet.snsapp.qq.com/v2/cgi-bin/sweet_share_qzone_comment_get", "")?>
	...
	<?cs each:i = g_data_comments.index?>
		...
		<?cs call:data_commentReply_more_param(tmp_more_param)?>
