...
<?cs def:_comment_replies_list(replies)?>
	...
	<?cs if:_end_reply < 2?>
		<?cs set:_end_reply = 2?>
	<?cs /if?>
	<?cs loop:i = _end_reply-2, _end_reply, 1?>
	<?cs with:reply = replies.reply[i]?>
		<li class="comment_item" data-role="lireplyroot">
			<div class="comment_main">
				<div class="comment_txt">
					...
					<a href="#"
						 ...
						 data-role="replyroot"
						 data-param="<?cs var:reply.replybtn.param?>"
...
<?cs def:_comments_list()?>
	...
	<?cs with:commentItem = qfv.comments.comment[i]?>
		...
		<li class="comment_item" data-role="licommentroot">
			<div class="comment_main">
				<div class="comment_txt">
					...
					<a href="#"
						 ...
						 data-param="<?cs var:commentItem.replybtn.param?>"
						 data-hctag="spcaretab.reply.click"
						><i class="ui_icon icon_reply_gray"></i></a>
				</div>
			</div>
