...
typedef CBOOL (*dictCleanupFunc)(char *id, void *value, void *rock);
typedef void (*dictFreeValueFunc)(void *value, void *rock);

NEOERR *dictCreate(dictCtx *dict, CBOOL threaded, UINT32 root, UINT32 maxLevel, 
    UINT32 flushLimit, CBOOL useCase, 
...
CBOOL dictRemove(dictCtx dict, const char *id);
/*
