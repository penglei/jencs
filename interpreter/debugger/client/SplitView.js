 ...
 */
function SplitView(isVertical, sidebarSizeSettingName, defaultSidebarWidth, defaultSidebarHeight)
{
    View.call(this);
...
SplitView.prototype = {
    ...
    {
        UIUtils._elementDragStart(this._startResizerDragging.bind(this), this._resizerDragging.bind(this), this._endResizerDragging.bind(this), this._isVertical ? "ew-resize" : "ns-resize", event);
    },
    ...
    _sizeSetting: function()
    {
        ...
        if (!CSInspector.settings[settingName])
            CSInspector.settings[settingName] = CSInspector.settings.createSetting(settingName, undefined);

        return CSInspector.settings[settingName];
    },
